...
def get_geo_pos(city: str) -> tuple:
    ...
    geolocator = geocoders.Nominatim(user_agent='Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/118.0.0.0 Safari/537.36')  # FIXME
